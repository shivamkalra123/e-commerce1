...
const moods = [
  { title: "Chill", img: chill, link: "/collection?mood=chill" },
  { title: "Work", img: work, link: "/collection?mood=work" },
  { title: "Night Out", img: night, link: "/collection?mood=night" },
  { title: "Everyday", img: everyday, link: "/collection" },
];
        ...
        {moods.map((mood) => (
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 text-white">
              <h3 className="text-2xl font-medium">{mood.title}</h3>
